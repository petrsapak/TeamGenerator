...
namespace TeamGenerator.Core
{
    public class BestComplementGenerator : IGenerate
    {
        ...
        {
            availablePlayerPool = generatorSettings.AvailablePlayerPool.ToList();
            ...
            while (generatorSettings.UseBots)
            {
                ...
                double team1BotEvaluation = team1RankAverage * generatorSettings.BotQuotient;

                double team2RankAverage = team2EvaluationWithoutBots / (double)team2Buffer.Players.Count;
                double team2BotEvaluation = team2RankAverage * generatorSettings.BotQuotient;

                double teamEvaluationDifference = team1Evaluation - team2Evaluation;

                if (botCounter < generatorSettings.MaxBotCount)
                {
